...
// Запуск: см. tests/README.md.
//
// Зелёные — базовое поведение и регрессия по фикс-сессиям.
// Красные (намеренно) падают на открытых дефектах:
//   APP-009 -> BUG-03 (разделитель разрядов в сумме)
//   APP-014 -> BUG-04 (валидный JSON с неверной схемой роняет историю)
// APP-003 был красным до фикс-сессии BUG-01; после фикса — зелёный, оставлен
// как регрессионная страховка.
