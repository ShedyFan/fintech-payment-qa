...
STAGE = r"C:\Users\Tester_QA\AppData\Local\Temp\qabuild"
CHROME = r"C:\Program Files\Google\Chrome\Application\chrome.exe"

DATE_HUMAN = "28 августа 2026"
...
DOCS_SPEC = [
    {
        ...
        "summary": (
            ...
            "переводы и лимиты, карты и отмена операции, комиссии и округление. Это стенд, "
            "а не действующая система — сценарии проверяются на готовность к исполнению, "
            "фактический прогон на продукте не предполагается.\n\n"
    ...
    },
    {
        ...
        "toc_depth": 3,
        "summary": (
            "**Что это.** Отчёт по домашнему заданию №2 (вариант A4): тест-план платёжных "
            "сценариев, собранный тремя рабочими ветками с независимой проверкой полноты и "
            "попыткой скомпрометировать собственную работу. Продукта под планом нет — это стенд.\n\n"
            "**Структура.** Восемь разделов по пунктам задания плюс «Честные тупики» и "
            "«Инструменты».\n\n"
            "| Раздел | Тема | Кратко |\n"
            "| --- | --- | --- |\n"
            "| 1 | Работающий результат | сводный `test-plan.md`: 136 сценариев, находки скептика, чек-лист денег |\n"
            "| 2 | Агенты параллельно | один задокументированный субагент (проверка полноты); параллельного авторства областей в git не видно |\n"
            "| 3 | Workflow | `qa-regression-workflow.md` прогонялся один раз, с отклонениями |\n"
            ...
            "**Тон.** Фиксируются и удачи, и осечки: незакоммиченное сведение плана, отклонения "
            "от workflow, устаревший прежний PDF, неубранные worktrees. Раздел «Честные тупики» "
            "собирает все промахи, включая мелкие."
        ),
    },
]
